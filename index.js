...
function sortedHotelsDesc(hotel1, hotel2) {
  return hotel2.price - hotel1.price;
}
function sortedHotelsAsc(hotel1, hotel2) {
...
app.get('/hotels/sort/pricing', (req, res) => {
  ...
  if (pricing === 'high-to-low') {
    sortedHotels = hotelsCopy.sort(sortedHotelsDesc);
  }
  if (pricing === 'low-to-high') {
    sortedHotels = hotelsCopy.sort(sortedHotelsAsc);
  }

  res.json(sortedHotels);
});

function sortedRatingsDesc(hotel1, hotel2) {
  return hotel2.rating - hotel1.rating;
}
function sortedRatingsAsc(hotel1, hotel2) {
...
app.get('/hotels/sort/rating', (req, res) => {
  ...
  if (rating === 'high-to-low') {
    sortedHotels = hotelsCopy.sort(sortedRatingsDesc);
  }
  if (rating === 'low-to-high') {
    sortedHotels = hotelsCopy.sort(sortedRatingsAsc);
  }

  res.json(sortedHotels);
});

function sortedReviewsDesc(hotel1, hotel2) {
  return hotel2.reviews - hotel1.reviews;
}
function sortedReviewsAsc(hotel1, hotel2) {
...
app.get('/hotels/sort/reviews', (req, res) => {
  ...
  if (reviews === 'most-to-least') {
    sortedHotels = hotelsCopy.sort(sortedReviewsDesc);
  }
  if (reviews === 'least-to-most') {
    sortedHotels = hotelsCopy.sort(sortedReviewsAsc);
  }
...
app.get('/hotels/filter/amenity', (req, res) => {
  ...
  let hotelsCopy = hotels.slice();
  let sortedHotels = hotelsCopy.filter((hotel) =>
